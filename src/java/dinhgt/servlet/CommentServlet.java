...
public class CommentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = commentDAO.newCommentArticle(comment, email, postid, date);
            if(result){
                TblNotificationDAO notiDAO = new TblNotificationDAO();
                result = notiDAO.commentNotification(email, postid, date, "Comment");
                if(result){
                    url = "ServletDispatcher?btAction=ViewDetails&txtPostID="+postid;
                }
            }
