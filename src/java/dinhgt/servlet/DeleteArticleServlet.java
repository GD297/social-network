...
public class DeleteArticleServlet extends HttpServlet {
    ...
    static final Logger LOGGER = Logger.getLogger(DeleteArticleServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TblArticleDAO articlDAO = new TblArticleDAO();
            boolean result = articlDAO.deleteArticle(postid);
            if (result) {
                url = "LoadCurrentUserArticle";
            }
