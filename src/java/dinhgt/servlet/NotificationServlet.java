...
import dinhgt.tblnotification.TblNotificationDTO;
...
public class NotificationServlet extends HttpServlet {
    ...
    private final String NOTIFICATION_PAGE = "notificationPage.jsp";
    static final Logger LOGGER = Logger.getLogger(NotificationServlet.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            notiDAO.loadNotification(email);
            List<TblNotificationDTO> listNoti = notiDAO.getListNoti();
            request.setAttribute("LIST_NOTIFICATION", listNoti);
